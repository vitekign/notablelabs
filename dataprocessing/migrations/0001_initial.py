# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2017-12-27 20:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fish_test_component', models.CharField(max_length=64)),
                ('fish_test_component_percentage', models.CharField(max_length=64)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('immunophenotype_cytochemistry_percent_positive', models.CharField(max_length=64)),
                ('immunophenotype_cytochemistry_testing_result', models.CharField(max_length=64)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('molecular_analysis_abnormality_testing_percentage_value', models.CharField(max_length=64)),
                ('molecular_analysis_abnormality_testing_result', models.CharField(max_length=64)),
            ],
        ),
        migrations.CreateModel(
            name='Patient',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cytogenetic_abnormalities_1', models.CharField(default='cytogenetic_abnormalities', max_length=64)),
                ...
                ('fish_test_component_results', models.CharField(default='', max_length=64)),
